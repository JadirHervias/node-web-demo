...
<style>
  :root {
    ...
    --primarioOscuro: rgb(189, 195, 253);
...
<body style="background-color: rgb(247, 247, 255);">

  <div class="container-fluid sticky-top" style="background-color: rgb(90, 162, 235);">
    <nav class="navbar navbar-expand-md navbar-dark container" style="background-color: rgb(90, 162, 235);">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="#">Lista de Contactos</a>
            </div>
          </li>
        </ul>
      </div>
  ...
  <div class="bg-amarillo contenedor sombra">
    <form id="contacto" action="#">
      <legend>Contacto Agregado</legend>

      <div class="campos">
        <div class="campo">
          <label for="nombre">Nombre:</label>
          <input type="text" placeholder="${newContact.id}" id="nombre" disabled>
        </div>
        <div class="campo">
          <label for="apellido">Apellido:</label>
          <input type="text" placeholder="${newContact.nombre}" id="apellido" disabled>
        </div>
        <div class="campo">
          <label for="celular">Celular:</label>
          <input type="text" placeholder="${newContact.apellido}" id="celular" disabled>
        </div>
      ...
      <div class="campos">
        <div class="campo">
          ...
          <input type="text" placeholder="${newContact.correo}" id="telefono" disabled>
        </div>
        <div class="campo">
          <label for="email">Email:</label>
          <input type="text" placeholder="${newContact.telefono}" id="email" disabled>
        </div>
        <div class="campo">
          <label for="dni">DNI:</label>
          <input type="text" placeholder="${newContact.fechaNacimiento}" id="dni" disabled>
        </div>
        <div class="campo">
          <label for="dni">DNI:</label>
          <input type="text" placeholder="${newContact.mensaje}" id="dni" disabled>
        </div>
      </div>
